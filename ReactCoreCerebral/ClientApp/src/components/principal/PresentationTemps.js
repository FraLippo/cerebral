...
this.nomMois = moisEnFrancais[d.getMonth()];
  ...
  render() {
    return <div>
      ...
      <p className='fontMoyenne'>👑 Félicitations à Gwendal, Meneleus, Quentin (2 fois),  rvteo et inconnu583 en novembre. 👑</p>
