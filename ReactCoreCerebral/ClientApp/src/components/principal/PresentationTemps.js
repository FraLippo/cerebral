  ...
  render() {
    return <div>
      ...
      <p className='fontMoyenne'>👑 <span className='champVitesse'>Gwendal x2</span>  <span className='champVitesse'>Meneleus</span> <span className='champVitesse'>Quentin x2</span> <span className='champVitesse'>rvteo x2</span> <span className='champVitesse'>waïra x2</span>
       <span className='champVitesse'>inconnu583 x6</span> <span className='champVitesse'>Lili55 x2</span>👑</p>
      <h3 className='centre'>🚩 Deuxième victoire consécutive pour Lili55 ! 📅</h3>
      <div className='centre'>Pour la première fois, nous dépassons les 500 participants dans le mois.</div>
