...
export default function Podium(props)
{
    ...
    <div className="placePodium place3Podium">3</div></div><div className="placePrenomPodium">{props.tabPrenoms.length >= 1 &&<div  className="prenomPodium">{props.tabPrenoms[0].includes('@') ? props.tabPrenoms[0].split('@')[0].slice(0,10) : props.tabPrenoms[0].slice(0,10)}<div><img src={coupe} alt="coupe"></img></div></div>}
